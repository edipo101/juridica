<div class="btn-group">
	...
	<ul class="dropdown-menu" role="menu">
		<li><a id="btn-view-details" href="#" data-toggle="modal" data-target="#modal-view" onclick="view_details({{isset($route_id) ? $id.', '.$route_id : $id}})"><i class="fa fa-info"></i>Ver documento</a></li>
