<div class="btn-group">
	...
	<ul class="dropdown-menu" role="menu">
		...
		@endif
		{{-- @if (($status_id == 2) && isset($route_id) && ($route_sent == 0)) --}}
		@if (($status_id == 2))
		<li class="divider"></li>
		<li><a href="#" data-toggle="modal" data-target="#modal-send" onclick="send({{$id}}, {{$route_id}})"><i class="fa fa-mail-forward"></i>Reenviar a</a></li>
		@endif
		@if (($status_id == 2))
		<li><a href="#" data-toggle="modal" data-target="#modal-send" onclick="send({{$id}}, {{$route_id}})"><i class="fa fa-mail-reply"></i>Responder</a></li>
		@endif
		<li class="divider"></li>
		<li><a href="#" data-toggle="modal" data-target="#modal" onclick=""><i class="fa fa-archive"></i>Archivar</a></li>
	</ul>
</div>